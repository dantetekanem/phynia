...
class Main {
  ...
  async init() {
    ...
    this.enemies = await this.loadEnemies();
  ...
  async loadCharacters() {
    ...
    const guts = new Character({
      ...
      avatar: '/assets/Battle/Avatars/Guts.png',
      position: 'J6',
      maxHp: 214,
      hp: 214,
      maxMp: 50,
    ...
    const alma = new Character({
      id: 'alma',
      name: 'Alma Saryannt',
      avatar: '/assets/Battle/Avatars/hero.jpg',
      position: 'J6',
      maxHp: 214,
      hp: 214,
      maxMp: 50,
  ...
  async loadEnemies() {
    const enemies = [
      new Enemy({
        id: 'cave_goblin_a',
        name: 'Cave Goblin A',
        avatar: '/assets/Battle/Avatars/Goblin.png',
        position: 'C4',
        maxHp: 200,
        hp: 200,
        maxMp: 20,
